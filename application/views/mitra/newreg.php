        ...
        <div class="card-body">
            ...
            <div id="isiform" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <select id="fitur" onchange="pilihfitur(); " class=" js-example-basic-single fiturService" style="width:100%" name="id_fitur">
                        <option id="food" value="10">Food</option>
                        <option id="shop" value="11">Shop</option>
                        <option id="grochery" value="12">Grochery</option>
                        <option id="medic" value="13">Medic</option>
                    </select>
                </div>
                <div id="foodfitur" style="display:block;" class=" form-group">
                ...
                <div id="shopfitur" style="display:none;" class=" form-group">
                    <label class=mt-2 for=" ftr">Category Service</label>
                    <select class="js-example-basic-single" name="category_merchant" style="width:100%">
                        <?php foreach ($merchantk as $mck) {
                            if ($mck['id_fitur'] == 11) { ?>
                ...
                <div id="grocheryfitur" style="display:none;" class=" form-group">
                    <label class=mt-2 for=" ftr">Category Service</label>
                    <select class="js-example-basic-single" name="category_merchant" style="width:100%">
                        <?php foreach ($merchantk as $mck) {
                            if ($mck['id_fitur'] == 12) { ?>
                ...
                <div id="medicfitur" style="display:none;" class=" form-group">
                    <label class=mt-2 for=" ftr">Category Service</label>
                    <select class="js-example-basic-single" name="category_merchant" style="width:100%">
                        <?php foreach ($merchantk as $mck) {
                            if ($mck['id_fitur'] == 13) { ?>
...
<script>
    ...
    function pilihfitur() {
        ...
        let grochery = document.getElementById("grochery").value
        let medic = document.getElementById("medic").value


        if (fitur == shop) {
            document.getElementById("foodfitur").style = "display:none;"
            document.getElementById("grocheryfitur").style = "display:none;"
            document.getElementById("medicfitur").style = "display:none;"
            document.getElementById("shopfitur").style = "display:block;"
        }
        if (fitur == grochery) {
            document.getElementById("foodfitur").style = "display:none;"
            document.getElementById("medicfitur").style = "display:none;"
            document.getElementById("shopfitur").style = "display:none;"
            document.getElementById("grocheryfitur").style = "display:block;"
        }
        if (fitur == medic) {
            document.getElementById("foodfitur").style = "display:none;"
            document.getElementById("shopfitur").style = "display:none;"
            document.getElementById("grocheryfitur").style = "display:none;"
            document.getElementById("medicfitur").style = "display:block;"
        }
        if (fitur == food) {
            document.getElementById("foodfitur").style = "display:block;"
            document.getElementById("medicfitur").style = "display:none;"
            document.getElementById("shopfitur").style = "display:none;"
            document.getElementById("grocheryfitur").style = "display:none;"
        }
