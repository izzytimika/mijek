                                    ...
                                    <div class="tab-content" id="myTab3Content">
                                        <div class="tab-pane fade show active" id="detail" role="tabpanel" aria-labelledby="detail">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select onchange="selfit();" id="pilih" class=" js-example-basic-single fiturService" style="width:100%" name="id_fitur">

                                                        <option id="food" value="10" <?php if ($mitra['id_fitur'] == 10) { ?>selected<?php } ?>>Food</option>
                                                        <option id="shop" value="11" <?php if ($mitra['id_fitur'] == 11) { ?>selected<?php } ?>>Shop</option>
                                                        <option id="grochery" value="12" <?php if ($mitra['id_fitur'] == 12) { ?>selected<?php } ?>>Grochery</option>
                                                        <option id="medic" value="13" <?php if ($mitra['id_fitur'] == 13) { ?>selected<?php } ?>>Medic</option>
                                                    </select>
                                                </div>
                                            </div>

                                            <div class="form-group row" id="foodcat" style="display:none">
                                                <div class="col-lg-3">
                                            ...
                                            <div class="form-group row" id="shopcat" style="display:none">
                                                <div class="col-lg-3">
                                                    <label class=mt-2 for="ftr">Category Service</label>
                                                </div>
                                                <div class="col-lg-9">
                                            ...
                                            <div class="form-group row" id="grocherycat" style="display:none">
                                                <div class="col-lg-3">
                                                    <label class=mt-2 for="ftr">Category Service</label>
                                                </div>
                                                <div class="col-lg-9">
                                            ...
                                            <div class="form-group row" id="mediccat" style="display:none">
                                                <div class="col-lg-3">
                                                    <label class=mt-2 for="ftr">Category Service</label>
                                                </div>
                                                <div class="col-lg-9">
...
<script>
    function selfit() {
        pilih = document.getElementById("pilih").value;
        foodval = document.getElementById("food").value;
        shopval = document.getElementById("shop").value;
        grocheryval = document.getElementById("grochery").value;
        medicval = document.getElementById("medic").value;
        console.log(pilih, foodval, shopval, grocheryval, medicval)

        if (pilih == foodval) {
            document.getElementById('foodcat').style.display = "block";
            document.getElementById('grocherycat').style.display = "none";
            document.getElementById('shopcat').style.display = "none";
            document.getElementById('mediccat').style.display = "none";
        }
        if (pilih == shopval) {
            document.getElementById('foodcat').style.display = "none";
            document.getElementById('grocherycat').style.display = "none";
            document.getElementById('shopcat').style.display = "block";
            document.getElementById('mediccat').style.display = "none";
        }
        if (pilih == grocheryval) {
            document.getElementById('foodcat').style.display = "none";
            document.getElementById('grocherycat').style.display = "block";
            document.getElementById('shopcat').style.display = "none";
            document.getElementById('mediccat').style.display = "none";
        }
        if (pilih == medicval) {
            ...
            document.getElementById('grocherycat').style.display = "none";
            document.getElementById('shopcat').style.display = "none";
            document.getElementById('mediccat').style.display = "block";
        }
    }

    foodval = document.getElementById("food");
    shopval = document.getElementById("shop");
    grocheryval = document.getElementById("grochery");
    medicval = document.getElementById("medic");
    console.log(foodval, shopval, grocheryval, medicval)
    if (foodval.selected == true) {
        document.getElementById('foodcat').style.display = "block";
        document.getElementById('grocherycat').style.display = "none";
        document.getElementById('shopcat').style.display = "none";
        document.getElementById('mediccat').style.display = "none";
    }
    if (shopval.selected == true) {
        document.getElementById('foodcat').style.display = "none";
        document.getElementById('grocherycat').style.display = "none";
        document.getElementById('shopcat').style.display = "block";
        document.getElementById('mediccat').style.display = "none";
    }
    if (grocheryval.selected == true) {
        document.getElementById('foodcat').style.display = "none";
        document.getElementById('grocherycat').style.display = "block";
        document.getElementById('shopcat').style.display = "none";
        document.getElementById('mediccat').style.display = "none";
    }
    if (medicval.selected == true) {
        document.getElementById('foodcat').style.display = "none";
        document.getElementById('grocherycat').style.display = "none";
        document.getElementById('shopcat').style.display = "none";
        document.getElementById('mediccat').style.display = "block";
