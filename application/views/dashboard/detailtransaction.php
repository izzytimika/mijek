                    ...
                    <div class="card">
                        <div class="card-body avatar">
                            ...
                            <div class="row">
                                ...
                                <?php if ($transaksi['id_fitur'] == 10 or $transaksi['id_fitur'] == 11 or $transaksi['id_fitur'] == 12 or $transaksi['id_fitur'] == 13) { ?>
                            ...
                            <div class="container-fluid mt-5 w-100">
                                ...
                                <p class="text-right mb-2">Discount
                                    <span class="text-danger">
                                        ...
                                        %)</span>
                                    :<?= $currency['app_currency'] ?>
                                    <?= number_format($transaksi['kredit_promo']) ?></p>
                                <br>
                                ...
                                <h4 class="text-right mb-5">Total :
                                    <?= $currency['app_currency'] ?>
                                    <?= number_format($transaksi['biaya_akhir']) ?></h4>
                                <hr>
                            </div>
                                        ...
                                        <tbody>
                                            <tr class="text-right">
                                                ...
                                                <td><?= $currency['app_currency'] ?>
                                                    <?= number_format($transaksi['biaya']) ?></td>
                                                <td><?= $currency['app_currency'] ?>
                                                    <?= number_format($transaksi['harga']) ?></td>
                                            </tr>
