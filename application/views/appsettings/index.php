                ...
                <div class="card-body">
                    ...
                    <div class="tab-minimal tab-minimal-success">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="tab-2-6" data-toggle="tab" href="#banktransfer-2-6" role="tab" aria-controls="banktransfer-2-6" aria-selected="false">
                        ...
                        <div class="tab-content col-12 justify-content-center">
                            ...
                            <div class="tab-pane fade" id="banktransfer-2-6" role="tabpanel" aria-labelledby="tab-2-6">
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
